...
import numpy as np
try:
    from DSVC.im2col_cython import col2im_cython, im2col_cython
    from DSVC.im2col_cython import col2im_6d_cython
except ImportError:
    print('run the following from the DSVC directory and try again:')
    print('python setup.py build_ext --inplace')
    print('You may also need to restart your iPython kernel')

from DSVC.im2col import *
